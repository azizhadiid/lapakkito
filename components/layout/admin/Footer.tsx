                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
                    ...
                    <div className="flex flex-col items-center text-center md:items-start md:text-left lg:col-span-2">
                        <Link href="/" className="mb-4">
                            <img src="/images/white logo vertikal.png" alt="Lapak Kito Logo" className="h-13 w-auto" />
                        </Link>
                    ...
                    {/* === Kolom 3: Bantuan === */}
                    <div className="flex flex-col items-center text-center md:items-start md:text-left">
                        <h3 className="text-lg font-semibold mb-4 text-[#F7F6F6]">Bantuan</h3>
                        <ul className="space-y-3">
                    ...
                    {/* === Kolom 4: Kontak === */}
                    <div className="flex flex-col items-center text-center md:items-start md:text-left">
                        <h3 className="text-lg font-semibold mb-4 text-[#F7F6F6]">Kontak</h3>
