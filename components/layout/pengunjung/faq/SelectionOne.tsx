    ...
    return (
        <section className="relative py-23 md:py-30">
            <div className="max-w-xl md:max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-2xl md:text-3xl text-center font-semibold mb-2">Frequently Asked Questions</h1>
                <p className="text-gray-600 mb-6 text-center text-sm md:text-base">Pertanyaan yang sering diajukan tentang penggunaan LapakKito.</p>
